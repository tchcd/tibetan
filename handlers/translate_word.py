...
async def send_new_translate_word(message: Message):
...
async def check_answer_translate(message: Message):
    ...
    if user_answer == correct_answer:
        ...
        #await send_new_translate_word(message)
    else:
...
#     dp.register_message_handler(lambda message: send_new_word(message, dp), commands=['hello'])
#     dp.register_message_handler(lambda message: check_answer(message, dp))
#     dp.storage = storage

# def translate_words(dp):
