...
from words_training import words_get_word, words_get_wrong_translation#, words_check_answer
...
#@dp.message_handler(state=GuessWordStates.waiting_for_letter)
...
def run(dp):
    ...
    #dp.register_message_handler(words_check_answer)